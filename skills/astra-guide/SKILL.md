...
```
Step R.1: 시스템 통합 테스트
  /project-test               서버 실행 + Chrome MCP 통합 테스트
  - API 연동 테스트
  - DB 데이터 정합성 확인
  - 성능 프로파일링
  - 크로스 브라우저/반응형 테스트
...
ASTRA 도구:
  /project-init [프로젝트 정보] Sprint 0 초기 세팅
  /astra-setup                전역 개발환경 설정
  /project-sprint [번호]      스프린트 초기화
  /project-test [URL/시나리오] 서버 실행 + Chrome MCP 통합 테스트
  /project-checklist          Sprint 0 완료 검증
